...
public class RadiologyReport implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://www.PAHospital.org/RadiologyService/", "RadiologyReport",
			"ns1");
	...
	public void serialize(final javax.xml.namespace.QName parentQName,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":RadiologyReport", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"RadiologyReport", xmlWriter);
			}
		...
		if (localRadiologyOrderID == null) {
			...
			throw new org.apache.axis2.databinding.ADBException(
					"RadiologyOrderID cannot be null!!");
		...
		if (localDateOfExamination == null) {
			...
			throw new org.apache.axis2.databinding.ADBException(
					"DateOfExamination cannot be null!!");

		} else {

			xmlWriter
					.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
							.convertToString(localDateOfExamination));
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		elementList.add(new javax.xml.namespace.QName("", "RadiologyOrderID"));

		if (localRadiologyOrderID != null) {
			elementList.add(org.apache.axis2.databinding.utils.ConverterUtil
					.convertToString(localRadiologyOrderID));
		} else {
			throw new org.apache.axis2.databinding.ADBException(
					"RadiologyOrderID cannot be null!!");
		}

		elementList.add(new javax.xml.namespace.QName("", "DateOfExamination"));
		...
		elementList.add(new javax.xml.namespace.QName("", "ReportText"));

		if (localReportText != null) {
			elementList.add(org.apache.axis2.databinding.utils.ConverterUtil
					.convertToString(localReportText));
		} else {
			throw new org.apache.axis2.databinding.ADBException(
					"ReportText cannot be null!!");
		}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static RadiologyReport parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			RadiologyReport object = new RadiologyReport();
			...
			try {
						...
						if (!"RadiologyReport".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (RadiologyReport) org.pahospital.www.radiologyservice.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("", "RadiologyOrderID")
								.equals(reader.getName())) {

					java.lang.String content = reader.getElementText();

					object.setRadiologyOrderID(org.apache.axis2.databinding.utils.ConverterUtil
							.convertToString(content));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("",
								"DateOfExamination").equals(reader.getName())) {

					java.lang.String content = reader.getElementText();

					object.setDateOfExamination(org.apache.axis2.databinding.utils.ConverterUtil
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("", "ReportText")
								.equals(reader.getName())) {

					java.lang.String content = reader.getElementText();

					object.setReportText(org.apache.axis2.databinding.utils.ConverterUtil
							.convertToString(content));

...
public class RadiologyOrder implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://www.PAHospital.org/RadiologyService/", "RadiologyOrder",
			"ns1");
	 ...
	 *            ExaminationType
	 */
	public void setExaminationType(
			org.pahospital.www.radiologyservice.ExaminationType_type1 param) {
	...
	public void serialize(final javax.xml.namespace.QName parentQName,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":RadiologyOrder", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"RadiologyOrder", xmlWriter);
			}
		...
		if (localExaminationType == null) {
			throw new org.apache.axis2.databinding.ADBException(
					"ExaminationType cannot be null!!");
		}
		localExaminationType.serialize(new javax.xml.namespace.QName("",
				"ExaminationType"), xmlWriter);
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		elementList.add(new javax.xml.namespace.QName("", "CaseID"));

		if (localCaseID != null) {
			elementList.add(org.apache.axis2.databinding.utils.ConverterUtil
					.convertToString(localCaseID));
		} else {
			throw new org.apache.axis2.databinding.ADBException(
					"CaseID cannot be null!!");
		}

		elementList.add(new javax.xml.namespace.QName("", "ExaminationType"));
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static RadiologyOrder parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			RadiologyOrder object = new RadiologyOrder();
			...
			try {
						...
						if (!"RadiologyOrder".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (RadiologyOrder) org.pahospital.www.radiologyservice.ExtensionMapper
				...
				if (reader.isStartElement()
					...
					object.setCaseID(org.apache.axis2.databinding.utils.ConverterUtil
							.convertToString(content));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("", "ExaminationType")
								.equals(reader.getName())) {

					object.setExaminationType(org.pahospital.www.radiologyservice.ExaminationType_type1.Factory
							.parse(reader));

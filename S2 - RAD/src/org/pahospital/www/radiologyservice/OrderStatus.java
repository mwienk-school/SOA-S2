...
/**
 * OrderStatus bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class OrderStatus implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://www.PAHospital.org/RadiologyService/", "OrderStatus", "ns1");
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":OrderStatus", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"OrderStatus", xmlWriter);
			}
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		elementList.add(new javax.xml.namespace.QName("", "OrderStatus"));

		if (localOrderStatus != null) {
			elementList.add(org.apache.axis2.databinding.utils.ConverterUtil
					.convertToString(localOrderStatus));
		} else {
			throw new org.apache.axis2.databinding.ADBException(
					"OrderStatus cannot be null!!");
		}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static OrderStatus parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			OrderStatus object = new OrderStatus();
			...
			try {
						...
						if (!"OrderStatus".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (OrderStatus) org.pahospital.www.radiologyservice.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("", "OrderStatus")
								.equals(reader.getName())) {

					java.lang.String content = reader.getElementText();

					object.setOrderStatus(org.apache.axis2.databinding.utils.ConverterUtil
							.convertToString(content));

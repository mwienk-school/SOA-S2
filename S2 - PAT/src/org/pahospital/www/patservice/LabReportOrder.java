 ...
 */
            ...
            /**
            *  LabReportOrder bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class LabReportOrder
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":LabReportOrder",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "LabReportOrder",
    ...
    public static class Factory{
        ...
        */
        public static LabReportOrder parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            LabReportOrder object =
                new LabReportOrder();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"LabReportOrder".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (LabReportOrder)org.pahospital.www.patservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

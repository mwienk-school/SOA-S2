            ...
            try {
                ...
                while(!reader.isEndElement()) {
                    if (reader.isStartElement() ){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.PAHospital.org/PatService/","PatientID").equals(reader.getName())){

 ...
 */
                           ...
                           public  java.lang.String[] getPatientID(){
                             ...
                             */
                             public void addPatientID(java.lang.String param){
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localPatientID);
                               list.add(param);
                               this.localPatientID =
                                   ...
                                   for (int i = 0;i < localPatientID.length;i++){
                                            ...
                                            if (localPatientID[i] != null){
                                                ...
                                                writeStartElement(null, namespace, "PatientID", xmlWriter);
                                                        ...
                                                        xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localPatientID[i]));
                                  ...
                                  for (int i = 0;i < localPatientID.length;i++){
                                         ...
                                         if (localPatientID[i] != null){
                                          elementList.add(new javax.xml.namespace.QName("",
                                                                              "PatientID"));
                                          elementList.add(
                                          org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localPatientID[i]));
                                          } else {
    ...
    public static class Factory{
        ...
        */
        public static IDsList parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            IDsList object =
                new IDsList();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"IDsList".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (IDsList)org.pahospital.www.patservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                                    ...
                                    list1.add(reader.getElementText());
                                            ...
                                            while(!loopDone1){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("","PatientID").equals(reader.getName())){
                                                         list1.add(reader.getElementText());
                                            ...
                                            // call the converter utility  to convert and set the array
                                                    ...
                                                    object.setPatientID((java.lang.String[])
